...
?>
   <div class="sidebar">
    ...
    <div class="main-content">
       ...
       <div class="container-fluid">
        ...
        <div class="categories d-flex flex-wrap justify-content-center gap-3 mt-4">
            ...
            <button type="button" class="btn btn-link" style="font-weight: bold; font-size:large; margin-top: -4px">Fiction</button>
    ...
    <div class="book-grid">
    <?php
        $SELECTS_ALL_SCIENCE_BOOK = mysqli_query($conn, "SELECT * FROM books WHERE category ='FICTION' AND status= 'available'");
        if(mysqli_num_rows($SELECTS_ALL_SCIENCE_BOOK) > 0){
        while ($get_BOOKS = mysqli_fetch_assoc($SELECTS_ALL_SCIENCE_BOOK) ) {
            # code...
       
    ?>
        <button class="book"><a href="../pages/view_fiction.php?bookid=<?= $get_BOOKS['bookID']?>">
