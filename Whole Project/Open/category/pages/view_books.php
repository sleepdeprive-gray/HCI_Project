...
?>
   <div class="sidebar">
    ...
    <?php
    $IDS = $_GET['bookid'];
    $selectBOOK_info = mysqli_query($conn, "SELECT * FROM books WHERE book_id= $IDS");
    ...
    <div class="content-part">
        <div class="upper-content">
           <img src="data:image/jpeg;base64, <?=base64_encode($BOOKS_INFO['front_cover'])?>" />
            <div class="title-and-author">
                <h1><?= $BOOKS_INFO['title']?></h1>
                <h4>
                    <?php
                        $autID = $BOOKS_INFO['author_id'];
            ...
            <a href="books.php?genre=<?= $_GET['genre']?>">
                <button>Back</button>
            </a>
        </div>
        <div class="section-bg">
            ...
            <div class="details-part">  
                ...
                <div class="right-details">
                    ...
                    <p>
                    <?php
                        $autID = $BOOKS_INFO['editor_id'];
                        $select_the_name = mysqli_query($conn, "SELECT first_name FROM users WHERE user_id = $autID");

                        while ($theNAME = mysqli_fetch_assoc($select_the_name)) {
                            echo $theNAME['first_name'];
                        }
                    ?>
                    </p>
                    <h4>Language</h4>
                    ...
                    <a href="savebook.php?id=1&bookid=<?= $_GET['bookid']?>&genre=<?= $_GET['genre']?>">
