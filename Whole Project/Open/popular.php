...
?>
    ...
    <div class="main-content">
        ...
        <div class="container">
            <?php
            $PopularBOOKS = mysqli_query($conn, "SELECT * FROM books");
            // $PopularBOOKS = mysqli_query($conn, "SELECT * FROM books WHERE downloads > 3 AND status = 'Approved'");

            while ($eachBOOK = mysqli_fetch_assoc($PopularBOOKS)) {
              # code...
            
            ?>
            <a href="view.php?bookID=<?=$eachBOOK['book_id']?>&p=2">
            <div class="book">
              
                <img src="data:image/jpeg;base64, <?=base64_encode($eachBOOK['front_cover'])?>" />
              <div class="book-content">
                <h3><?= $eachBOOK['title'];?></h3>
                <p>By <?= $eachBOOK['author_id'];?></p>
