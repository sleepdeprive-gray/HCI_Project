        ...
        <table>
            ...
            <tbody>
                <?php
                    ...
                    $selectsALLsaveBooks = mysqli_query($conn, "SELECT * FROM `books` LEFT JOIN save_book ON books.book_id = save_book.save_bookID
                    WHERE save_book.userID = 1");
                    // save_book.userID = $id
                    if(mysqli_num_rows($selectsALLsaveBooks) > 0){
                    while ($bookSAVED = mysqli_fetch_assoc($selectsALLsaveBooks)) {
                    
                    
                ?>
                <tr>
                    <td style="text-align: center;"><?= $bookSAVED['title']?></td>
                    <td style="text-align: center;"><?= $bookSAVED['genre']?></td>
                    <td style="text-align: center;">
                        <form action="" method="post">
                            <input type="number" name="nums" id="" value="<?= $bookSAVED['save_bookID']?>" hidden>
              ...
              <?php
                    ...
                    <tr>
                        <td colspan="3" style="color:red; text-align:center">
                            No do not have any saved book yet !
                        </td>
                    </tr>
                    ';
                }
