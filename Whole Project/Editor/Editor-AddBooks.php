    ...
    <div class="form-background">
        <div class="form-container" enctype="multipart/form-data">
            ...
            <div class="form-group-author-genre" class="form-group">
                ...
                <input type="text" name="authorname" id="authorname" placeholder="Add author name here...">
            ...
            <div>
                ...
                <input type="text" name="description" id="description" placeholder="Add book description here...">
            </div>
