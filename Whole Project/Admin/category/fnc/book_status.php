<a href="book-status/book_status.php?s=<?= "Pending&c=".$category;?>"
                                style="margin-left: 10px;background-color: rgb(117, 59, 22); align-items: center; border-radius: 10px; display:flex; justify-content:center;box-shadow:5px 5px 5px rgba(0,0,0,0.8)">
