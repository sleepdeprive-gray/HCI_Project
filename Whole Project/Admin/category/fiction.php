            ...
            <div class="time">
                ...
                flex-wrap: wrap; ">
                        ...
                        <div class="" style="display: flex; justify-content: space-between;">
                            <div class="">   
                                <p style="font-weight: bold; color:white">FICTION BOOK</p>
                            </div>
                            ...
                            <table>
                                ...
                                <tbody>
                                    ...
                                    if(isset($_POST['orderBY'])){
                                         ...
                                         $selects_logs = mysqli_query($conn, "SELECT * FROM books WHERE `genre`= 'Fiction' ORDER BY $oderBY");
                                    }elseif($_POST['orderBY'] == "Highest"){
                                         $oderBY = 'downloads';
                                          $selects_logs = mysqli_query($conn, "SELECT * FROM books WHERE `genre`= 'Fiction' ORDER BY $oderBY DESC");
                                    }elseif ($_POST['orderBY'] == "Lowest") {
                                        $oderBY = 'downloads';
                                         $selects_logs = mysqli_query($conn, "SELECT * FROM books WHERE `genre`= 'Fiction' ORDER BY $oderBY ASC");
                                    }
                                    }else{
                                         $selects_logs = mysqli_query($conn, "SELECT * FROM books WHERE `genre`= 'Fiction' ORDER BY author_id");
                                    }
                        ...
                        <div class="" style="display: flex; justify-content:end; align-items:center">
                            ...
                            <a href="book-status/book_status.php?s=<?= 'Pending&c=Fiction';?>"
                            ...
                            <a href="book-status/book_status.php?s=<?= 'Approved&c=Fiction';?>"
                                style="margin-left: 10px;background-color: #3c554c; align-items: center; border-radius: 10px; display:flex; justify-content:center;box-shadow:5px 5px 5px rgba(0,0,0,0.8)">
                                <button style="width: 100%; border: none;background-color: transparent; color: white; cursor: pointer; padding:10px;">
                                    Approved
                                </button>
                            </a>
                            <a href="book-status/book_status.php?s=<?= 'Rejected&c=Fiction';?>"
                                style="margin-left: 10px;background-color: #3c554c; align-items: center; border-radius: 10px; display:flex; justify-content:center;box-shadow:5px 5px 5px rgba(0,0,0,0.8)">
                                <button style="width: 100%; border: none;background-color: transparent; color: white; cursor: pointer; padding:10px;">
                                    Rejected
                                </button>
                            </a>
                            <a href="book-status/book_status.php?s=<?= 'Archive&c=Fiction';?>"
                                style="margin-left: 10px;background-color: #3c554c; align-items: center; border-radius: 10px; display:flex; justify-content:center;box-shadow:5px 5px 5px rgba(0,0,0,0.8)">
                                <button style="width: 100%; border: none;background-color: transparent; color: white; cursor: pointer; padding:10px;">
                                    Archive
                                </button>
